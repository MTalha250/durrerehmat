    ...
    return (
      ...
      >
        <div className="flex flex-col items-center justify-center py-8 text-center">
          ...
          <div className="mt-6 flex items-center gap-2 rounded-full bg-secondary/10 px-4 py-2 text-sm font-medium text-secondary">
    ...
    >
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-4">
            {volunteerTypeData.map((item) => (
              ...
              >
                <div
                  className={`flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br ${item.color} text-white shadow-lg transition-transform group-hover:scale-110`}
                >
                  {item.icon}
                </div>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="group">
              ...
              <input
                ...
                required
                className="w-full rounded-xl border-2 border-gray-200 px-4 py-3 transition-all focus:border-secondary focus:outline-none focus:ring-4 focus:ring-secondary/10"
        ...
        {selectedTypeData && (
          <div className="overflow-hidden rounded-2xl border border-gray-100 bg-gradient-to-br from-gray-50 to-white">
            <div className="flex items-center gap-3 border-b border-gray-100 bg-white px-5 py-3">
              <div
                className={`flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br ${selectedTypeData.color} text-white`}
              >
                {selectedTypeData.icon}
              </div>
              <div>
                <p className="text-xs text-gray-500">Volunteering as</p>
        ...
        <button
          ...
          className="group relative w-full overflow-hidden rounded-xl bg-gradient-to-r from-secondary to-secondary/90 px-8 py-4 font-semibold text-white shadow-lg shadow-secondary/30 transition-all hover:shadow-xl hover:shadow-secondary/40 disabled:opacity-50 disabled:shadow-none"
        >
