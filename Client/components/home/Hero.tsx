  ...
  return (
    <div className="h-screen w-full">
      <div className="relative h-[80vh] w-full">
        ...
        <div className="relative z-20 flex h-full w-full items-center px-32 text-white">
        ...
        <div className="absolute bottom-0 z-20 flex w-full translate-y-1/2 items-center justify-center gap-10">
